...
$title = $siteName . ' - 404 ошибка, страница перемещина или удалена';
...
<div class="container">
    ...
    <br/>
    Пожалуйста, перейдите на <a href="<?=SITE_DIR?>">главную страницу сайта</a>, в <a href="<?=SITE_DIR?>catalog/">каталог товаров</a>.
</div>
