 ...
 <footer>
    ...
    <script src="/assets/js/libs/slick.js" type="text/javascript"></script>
    <script src="/assets/js/libs/anime.js" type="text/javascript"></script>
    <script src="/assets/js/libs/scroll/jquery.mousewheel.js" type="text/javascript"></script>
    <script src="/assets/js/libs/scroll/jquery.jscrollpane.min.js" type="text/javascript"></script>
    <!-- Core JS Files -->
