    ...
    <div class="container">
        ...
        <? $APPLICATION->IncludeComponent(
            ...
            Array(
                ...
                'REQUEST_QUERY' => (empty($_GET['q']) ? '' : $_GET['q']),
            ),
            $component,
            array('HIDE_ICONS' => 'Y')
        ); ?>
        ...
        <div class="row">
            <? if($arParams["USE_FILTER"] == "Y"): ?>
                <div class="container-aside">
                    ...
                    <div class="tm-carousel">
                        <? $APPLICATION->IncludeComponent('bitrix:news.list', 'our_tm_catalog_search', array(
                            'DISPLAY_DATE' => 'Y',
                            'DISPLAY_NAME' => 'Y',
                            'DISPLAY_PICTURE' => 'Y',
            ...
            <div class="container-main">
                <? if(empty($arResult['VARIABLES']['q'])): ?>
                    <? $APPLICATION->IncludeComponent('bitrix:catalog.section.list', 'catalog_section_slider', array(
                        'VIEW_MODE' => 'TEXT',
                        'SHOW_PARENT_NAME' => 'Y',
                        'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
                        'IBLOCK_ID' => $arParams['IBLOCK_ID'],
