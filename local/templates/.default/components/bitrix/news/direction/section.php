...
<div class="background-page">
	...
	array(
		...
		"AJAX_OPTION_HISTORY" => "N",
		"AJAX_OPTION_ADDITIONAL" => "",
		"COMPONENT_TEMPLATE" => "direction_slider_events",
    ...
    <div class="text-direct">
        <div class="container">
            <div class="row">
                <div class="col-24">
                    <p><?$APPLICATION->IncludeFile(SITE_DIR.'include/direction/text.php');?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            if(!empty($arResult['VARIABLES']['SECTION_CODE']))
                ${$arParams['FILTER_NAME']}['=PROPERTY_DIRECTION.CODE'] = $arResult['VARIABLES']['SECTION_CODE'];
            ?>
    ...
    <? $APPLICATION->IncludeComponent('bitrix:news.list', 'recipes_list', array(
        'DISPLAY_DATE' => 'Y',
        'DISPLAY_NAME' => 'Y',
        'DISPLAY_PICTURE' => 'Y',
        'DISPLAY_PREVIEW_TEXT' => 'Y',
