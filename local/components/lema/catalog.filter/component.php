		...
		case "L":
			...
			else
			{
				...
				if ($arProp["MULTIPLE"]=="Y")
					$res .= '<select class="cs-select cs-skin-border" multiple name="'.$name.'[]" size="'.$arParams["LIST_HEIGHT"].'">';
				else
					$res .= '<select class="cs-select cs-skin-border" name="'.$name.'">';
				$res .= '<option disabled selected value="">'.GetMessage("CC_BCF_ALL").'</option>';
				$list[""] = GetMessage("CC_BCF_ALL");
				foreach($arProp["VALUE_LIST"] as $key=>$val)
				{
					$res .= '<option';
		...
		case "L":
			...
			else
			{
				...
				if ($arProp["MULTIPLE"]=="Y")
					...
					$res .= '<select class="cs-select cs-skin-border" name="'.$name.'">';
				$res .= '<option disabled value="">'.GetMessage("CC_BCF_ALL").'</option>';
				$list[""] = GetMessage("CC_BCF_ALL");
				foreach($arProp["VALUE_LIST"] as $key=>$val)
				{
					$res .= '<option';
